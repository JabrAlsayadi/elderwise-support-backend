...
module.exports = {
    ...
    registrationMedical: (data, callback) => {
        const sql = `insert into medical_registration (hospitalName, createUser, hospitalAddress, registrationType, doctorName, fee, registrationStatus, registrationAt, createAt, updateAt, paymentStatus) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
    ...
    */
    getMedicalRegistrationById: (id, callback) => {
        const sql = `SELECT * FROM medical_registration WHERE id = ?`;
    ...
    */
    updateMedicalRegistrationById: (data, callback) => {
        const sql = `UPDATE medical_registration SET hospitalName = ?, hospitalAddress = ?, registrationType = ?, doctorName = ?, fee = ?, registrationStatus = ?, registrationAt = ?, updateAt = ?, paymentStatus = ? WHERE id = ?`;
